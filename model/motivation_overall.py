...
ax1.plot(x, overall_cc_speedup2[0], color=colors[2], label="GE-SpMM", linewidth=0.5)
ax1.plot(x, overall_tc_speedup2[0], color=colors[1], label="TC-SpMM", linewidth=0.5)
...
ax2.plot(x, overall_cc_speedup2[1], color=colors[2], label="GE-SpMM", linewidth=0.5)
ax2.plot(x, overall_tc_speedup2[1], color=colors[1], label="TC-SpMM", linewidth=0.5)
...
ax3.plot(x, overall_cc_speedup2[2], color=colors[2], label="GE-SpMM", linewidth=0.5)
ax3.plot(x, overall_tc_speedup2[2], color=colors[1], label="TC-SpMM", linewidth=0.5)
